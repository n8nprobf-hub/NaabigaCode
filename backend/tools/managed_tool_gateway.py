...
def auth_json_path():
    """Return the Naabiga auth store path, respecting NAABIGA_HOME overrides."""
    return get_naabiga_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`naabiga tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from naabiga_cli.auth import resolve_nous_access_token
