...
Trust levels:
  - builtin:   Ships with Thot. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.thot/\.env|\~/\.thot/\.env',
     "thot_env_access", "critical", "exfiltration",
     "directly references Thot secrets file"),
    ...
    (r'\.thot/config\.yaml|\.thot/SOUL\.md',
     "thot_config_mod", "critical", "persistence",
     "references Thot configuration files directly"),
...
# scan. `.skillignore` is the Thot-native name; `.clawhubignore` is honored
