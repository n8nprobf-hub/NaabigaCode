...
Trust levels:
  - builtin:   Ships with Naabiga. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.naabiga/\.env|\~/\.naabiga/\.env',
     "naabiga_env_access", "critical", "exfiltration",
     "directly references Naabiga secrets file"),
    ...
    (r'\.naabiga/config\.yaml|\.naabiga/SOUL\.md',
     "naabiga_config_mod", "critical", "persistence",
     "references Naabiga configuration files directly"),
...
# scan. `.skillignore` is the Naabiga-native name; `.clawhubignore` is honored
