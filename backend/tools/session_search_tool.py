...
the get_anchored_view / get_messages_around primitives in naabiga_state.
...
# Third-party integrations tag their sessions with NAABIGA_SESSION_SOURCE=tool;
...
def _resolve_profile_db(profile: str):
    ...
    from naabiga_cli import profiles as profiles_mod
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from naabiga_state import DEFAULT_DB_PATH
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Naabiga conversation history only. It is not evidence "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Naabiga conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Naabiga profile's database "
