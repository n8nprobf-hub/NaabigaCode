"""Language Server Protocol (LSP) integration for Thot Agent.

Thot runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``thot chat`` exit would leak pyright processes that
