...
See the ``naabiga-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Naabiga, e.g. 'naabiga-agent').\n"
    "  • Hub-installed skills (installed via 'naabiga skills install').\n"
    "Pinned skills (marked via 'naabiga curator pin') CAN be improved — "
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("NAABIGA_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _naabiga_now() timestamp, fresh
