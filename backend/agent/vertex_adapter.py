"""Vertex AI (Google Cloud) adapter for Naabiga Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Naabiga to use Gemini models via Google Cloud with
...
# who installed plain `naabiga-agent` and only later selected a Gemini model.
try:
