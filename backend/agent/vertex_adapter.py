"""Vertex AI (Google Cloud) adapter for Thot Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Thot to use Gemini models via Google Cloud with
...
# who installed plain `thot-agent` and only later selected a Gemini model.
try:
