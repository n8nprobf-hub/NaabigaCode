...
(3 SDK retries x 3 Naabiga retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_naabiga_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".naabiga")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Naabiga, ...) behind one endpoint.  A 429 can mean either:
