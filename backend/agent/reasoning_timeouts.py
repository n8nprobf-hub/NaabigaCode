...
first content token) routinely exceed Thot's default chat-model
stale detectors:

* Stream stale detector:   ``THOT_STREAM_STALE_TIMEOUT``     default 180s
                           ``agent/chat_completion_helpers.py:2544``
* Non-stream stale detector: ``THOT_API_CALL_STALE_TIMEOUT``  default 90s
                           ``run_agent.py:1140``
