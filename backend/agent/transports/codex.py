...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Naabiga's web-provider config and
        ...
        # native search engine for xAI sessions instead of Naabiga's
        # configured web provider (Tavily/etc.), and those results bypass
        # Naabiga's tool-trace / citation plumbing (they arrive baked into the
