...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Thot's web-provider config and
        ...
        # native search engine for xAI sessions instead of Thot's
        # configured web provider (Tavily/etc.), and those results bypass
        # Thot's tool-trace / citation plumbing (they arrive baked into the
