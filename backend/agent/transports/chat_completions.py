...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Naabiga/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Naabiga'
    ...
    # is stricter (low/high). Clamp Naabiga' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Naabiga-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Naabiga-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        is_nvidia_nim = params.get("is_nvidia_nim", False)  # noqa: F841 — kept for the
        # typed params contract (see Params is_nvidia_nim doc) even though the
        # chat_completions path does not branch on it today.
