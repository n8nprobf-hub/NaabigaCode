...
def load_context_engine(name: str) -> Optional["ContextEngine"]:  # noqa: F821 — forward ref
...
def _load_engine_from_dir(engine_dir: Path) -> Optional["ContextEngine"]:  # noqa: F821 — forward ref
