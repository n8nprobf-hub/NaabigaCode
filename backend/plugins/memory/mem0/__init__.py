...
Configuration
-------------
Secret (lives in $THOT_HOME/.env or the environment):
...
Behavioral settings (live in $THOT_HOME/mem0.json, set via `thot memory
setup`):
  ...
  agent_id           — Agent identifier (default: thot)
...
def _load_config() -> dict:
    """Load config from env vars, with $THOT_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "thot"),
        "oss": {},
    }
    ...
    config_path = get_thot_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, thot_home):
        """Write config to $THOT_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $THOT_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "thot")
