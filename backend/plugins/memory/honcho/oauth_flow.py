...
# The loopback redirect registered for the Naabiga OAuth client. IP-literal so
...
_DEFAULT_CLIENT_ID = "naabiga-agent"
...
def begin_authorization(
    ...
    *,
    ...
    (``naabiga-desktop`` / ``naabiga-cli``) so the consent side can attribute
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to Naabiga.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local NAABIGA_HOME override can't reach.
