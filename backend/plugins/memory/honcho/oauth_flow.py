...
# The loopback redirect registered for the Thot OAuth client. IP-literal so
...
def begin_authorization(
    ...
    *,
    ...
    (``thot-desktop`` / ``thot-cli``) so the consent side can attribute
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to Thot.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local THOT_HOME override can't reach.
