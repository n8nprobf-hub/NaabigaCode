...
``_check_spotify_available()`` — when the user has not run ``naabiga auth
spotify``, the tools remain registered (so they appear in ``naabiga
...
The Spotify auth flow (``naabiga auth spotify``), CLI plumbing, and docs
