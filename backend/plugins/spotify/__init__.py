...
``_check_spotify_available()`` — when the user has not run ``thot auth
spotify``, the tools remain registered (so they appear in ``thot
...
The Spotify auth flow (``thot auth spotify``), CLI plumbing, and docs
