"""Client for uploading ``thot debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``thot debug share``.
...
NAS_BASE = os.environ.get(
    "THOT_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "thot-agent/debug-share"
