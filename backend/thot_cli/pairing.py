...
Usage:
    thot pairing list              # Show all pending + approved users
    thot pairing approve <platform> <code>  # Approve a pairing code
    thot pairing revoke <platform> <user_id> # Revoke user access
    thot pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle thot pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: thot pairing {list|approve|revoke|clear-pending}")
        print("Run 'thot pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.thot/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'thot pairing list' to see pending codes.\n")
