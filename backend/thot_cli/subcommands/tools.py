...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'thot tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # thot tools disable <name...> [--platform cli]
    ...
    # thot tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `thot tools` runs after you pick a provider that\n"
