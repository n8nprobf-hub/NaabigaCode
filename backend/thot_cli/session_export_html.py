"""
HTML Export generator for Thot sessions.
...
<body>
    <div class="layout {layout_class}">
        ...
        <div class="main-content">
            ...
            <footer>
                Built with ☤ Thot Agent • Generated on {generated_at}
            </footer>
        </div>
    </div>
...
def generate_multi_session_html_export(sessions: List[Dict[str, Any]]) -> str:
    ...
    for s in sessions:
        sid = s.get("id", "N/A")
        title = s.get("title") or "Thot Session"
    ...
    return HTML_TEMPLATE.format(
        page_title="Thot Session Export" if is_multi else _escape_html(sessions[0].get("title", "Thot Session")),
