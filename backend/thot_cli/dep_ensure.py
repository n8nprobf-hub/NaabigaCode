...
def _has_thot_agent_browser() -> bool:
    ...
    # install.sh installs globally into $THOT_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-ThotHome", str(get_thot_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = thot_subprocess_env(inherit_credentials=False)
