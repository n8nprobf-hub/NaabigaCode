...
Entry point: ``naabiga whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``naabiga_cli/main.py``).
...
Naabiga gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Naabiga to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Naabiga needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Naabiga gateway in another terminal:")
    print("         naabiga gateway")
    print()
