...
Entry point: ``thot whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``thot_cli/main.py``).
...
Thot gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Thot to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Thot needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Thot gateway in another terminal:")
    print("         thot gateway")
    print()
