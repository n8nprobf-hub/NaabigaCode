"""Client for uploading ``naabiga debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``naabiga debug share``.
...
NAS_BASE = os.environ.get(
    "NAABIGA_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "naabiga-agent/debug-share"
