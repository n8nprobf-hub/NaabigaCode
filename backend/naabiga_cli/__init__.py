"""
Thot CLI - Unified command-line interface for Thot (CLI-only Thot fork).

Provides subcommands for:
- thot chat          - Interactive chat (same as ./thot)
- thot gateway       - Run gateway in foreground
- thot gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `thot setup` on a fresh Pi.
    ...
    thot_cli/stdio.py::configure_windows_stdio() runs later from the entry
