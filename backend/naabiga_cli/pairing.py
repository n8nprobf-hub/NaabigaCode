...
Usage:
    naabiga pairing list              # Show all pending + approved users
    naabiga pairing approve <platform> <code>  # Approve a pairing code
    naabiga pairing revoke <platform> <user_id> # Revoke user access
    naabiga pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle naabiga pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: naabiga pairing {list|approve|revoke|clear-pending}")
        print("Run 'naabiga pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.naabiga/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'naabiga pairing list' to see pending codes.\n")
