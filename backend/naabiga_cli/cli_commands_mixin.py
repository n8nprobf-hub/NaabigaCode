...
``cli.py``'s ``ThotCLI`` class. ``ThotCLI`` inherits ``CLICommandsMixin`` so
...
from thot_constants import display_thot_home, is_termux as _is_termux_environment
from thot_cli.browser_connect import (
...
class CLICommandsMixin:
    ...
    def _handle_rollback_command(self, command: str):
        ...
        if not mgr.enabled:
            ...
            print("  Enable with: thot --checkpoints")
    ...
    def _handle_snapshot_command(self, command: str):
        """Handle /snapshot — lightweight state snapshots for Thot config/state.
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_thot_home()}/state-snapshots/):\n")
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        """Handle /journey — the learning timeline (see `thot journey`).
        ...
        from cli import _cprint
        from thot_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from thot_cli.clipboard import has_clipboard_image
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(f"  {_DIM}Tip: type your next message, or run thot chat -q --image {_termux_example_image_path(image_path.name)} \"What do you see?\"{_RST}")
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in thot_cli/colors.py
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        """
        from cli import _cprint
        from thot_state import format_session_db_unavailable
        ...
        try:
            ...
            pass
        _cprint("  Timed out waiting for the gateway. Is `thot gateway` running?")
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not target:
            ...
            if self._show_recent_sessions(reason="resume"):
                ...
                return
            _cprint("  Tip:   Use /history or `thot sessions list` to find sessions.")
            return
        ...
        if target.isdigit():
            ...
            from thot_cli.main import _resolve_session_by_name_or_id
        ...
        if not session_meta:
            ...
            _cprint("  Use /history or `thot sessions list` to see available sessions.")
            return
    ...
    def _handle_branch_command(self, cmd_original: str) -> None:
        ...
        try:
            self._session_db.create_session(
                ...
                source=os.environ.get("THOT_SESSION_SOURCE", "cli"),
                model=self.model,
                model_config={
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from thot_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        from thot_cli.pets import _set_active
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from thot_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from thot_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to thot_cli.curator so the CLI and the `thot curator`
        ...
        try:
            from thot_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from thot_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to thot_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from thot_cli.write_approval_commands import handle_pending_subcommand
            ...
            if out is not None:
                print(out)
                return
        from thot_cli.skills_hub import handle_skills_slash
    ...
    def _handle_background_command(self, cmd: str):
        ...
        def run_background():
            ...
            try:
                ...
                if response:
                    try:
                        from thot_cli.skin_engine import get_active_skin
                        _skin = get_active_skin()
                        label = _skin.get_branding("response_label", "⚕ Thot")
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        Mirrors ``thot bundles list`` but renders inside the running
        ...
        if not bundles:
            ...
            _cprint(
                f"  {_DIM}Create one with: thot bundles create "
        ...
        _cprint(
            ...
            f"Manage with `thot bundles`.{_RST}"
        )
        ...
        if sub.startswith("connect"):
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a Thot-managed isolated debug "
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from thot_cli.goals import parse_contract
        ...
        _cprint(
            ...
            f"Thot keeps working until it is, you pause/clear it, or the budget is "
    ...
    def _handle_goal_draft(self, objective: str) -> None:
        ...
        from cli import _DIM, _RST, _cprint
        from thot_cli.goals import draft_contract
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from thot_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_thot_home()}/skins/\n")
            return
    ...
    def _compose_in_editor(self, initial_text: str = "") -> str:
        ...
        fd, path = tempfile.mkstemp(suffix=".md", prefix="thot_prompt_")
        try:
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        from thot_cli.config import load_config
        from thot_cli.colors import Colors as _Colors
    ...
    def _handle_busy_command(self, cmd: str):
        """Handle /busy — control what Enter does while Thot is working.
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                behavior = "Enter will queue follow-up input while Thot is busy."
            elif arg == "steer":
                behavior = "Enter will steer your message into the current run (after the next tool call)."
            else:
                behavior = "Enter will interrupt the current run while Thot is busy."
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from thot_cli.models import _is_anthropic_fast_model
    ...
    def _handle_debug_command(self, cmd_original: str = ""):
        ...
        """
        from thot_cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        """Handle /update — update Thot Agent to the latest version.

        In the classic CLI this exits the session and relaunches as
        ``thot update`` so the user sees update output directly and gets
        ...
        when cancelled.
        """
        from thot_cli.config import is_managed, format_managed_message

        if is_managed():
            print(f"  ✗ {format_managed_message('update Thot Agent')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Thot Agent"),
            ("cancel", "Cancel", "keep the current session"),
        ]
        raw = self._prompt_text_input_modal(
            title="⚕  Update Thot Agent",
            detail="This will exit the current session and run `thot update`.",
            choices=choices,
        )
        if raw is None:
