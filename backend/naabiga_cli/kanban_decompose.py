...
Invoked by ``thot kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Thot Agent board.
...
def _profile_author() -> str:
    """Mirror of ``thot_cli.kanban._profile_author``."""
    return (
