"""``naabiga tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'naabiga tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # naabiga tools list [--platform cli]
    ...
    # naabiga tools disable <name...> [--platform cli]
    ...
    # naabiga tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `naabiga tools` runs after you pick a provider that\n"
