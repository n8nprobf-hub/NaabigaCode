"""``naabiga slack`` subcommand parser.
...
def build_slack_parser(subparsers, *, cmd_slack: Callable) -> None:
    ...
    slack_parser = subparsers.add_parser(
        "slack",
        help="Aides d'intégration Slack (génération de manifest, etc.)",
        description="Aides d'intégration Slack pour Naabiga.",
    )
    ...
    slack_manifest.add_argument(
        ...
        "writes to $NAABIGA_HOME/slack-manifest.json.",
    )
    slack_manifest.add_argument(
        "--name",
        default=None,
        help='Bot display name (default: "Naabiga")',
    )
    slack_manifest.add_argument(
        "--description",
        default=None,
