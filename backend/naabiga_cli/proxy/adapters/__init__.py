...
from thot_cli.proxy.adapters.base import UpstreamAdapter
from thot_cli.proxy.adapters.nous_portal import NousPortalAdapter
from thot_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``thot proxy start --provider <name>`` CLI flag.
