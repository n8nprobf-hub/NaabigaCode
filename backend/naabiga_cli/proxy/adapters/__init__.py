...
from naabiga_cli.proxy.adapters.base import UpstreamAdapter
from naabiga_cli.proxy.adapters.nous_portal import NousPortalAdapter
from naabiga_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``naabiga proxy start --provider <name>`` CLI flag.
