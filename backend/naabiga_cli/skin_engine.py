"""Naabiga CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.naabiga/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Naabiga"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Naabiga "       # Response box header label
...
.. code-block:: python
    ...
    from naabiga_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Naabiga Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.naabiga/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Naabiga gold/kawaii (the current look)
...
Drop a YAML file in ``~/.naabiga/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces NAABIGA_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces NAABIGA_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Naabiga — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Naabiga",
            "welcome": "Welcome to Naabiga! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Naabiga ",
            "prompt_symbol": "❯",
