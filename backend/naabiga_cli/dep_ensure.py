...
def _has_naabiga_agent_browser() -> bool:
    ...
    # install.sh installs globally into $NAABIGA_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-NaabigaHome", str(get_naabiga_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = naabiga_subprocess_env(inherit_credentials=False)
