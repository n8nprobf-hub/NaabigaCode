"""
Skills configuration for Naabiga Agent.
`naabiga skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.naabiga/config.yaml under:
...
from naabiga_cli.config import cfg_get, load_config, save_config
from naabiga_cli.colors import Colors, color
from naabiga_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `naabiga skills`."""
    from naabiga_cli.curses_ui import curses_checklist
