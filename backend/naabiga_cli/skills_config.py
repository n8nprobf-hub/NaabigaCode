"""
Skills configuration for Thot Agent.
`thot skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.thot/config.yaml under:
...
from thot_cli.config import cfg_get, load_config, save_config
from thot_cli.colors import Colors, color
from thot_cli.platforms import PLATFORMS as _PLATFORMS
